...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\erick\Desktop\Advanced Topics\Week 6\groceries\src\pages\tabs\tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Grocery" tabIcon="ios-cart-outline"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="ios-information-circle-outline"></ion-tab>\n  <!-- Commented out unused contacts tab from start template\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>-->\n</ion-tabs>\n'/*ion-inline-end:"C:\Users\erick\Desktop\Advanced Topics\Week 6\groceries\src\pages\tabs\tabs.html"*/
        }),
...
var AboutPage = /** @class */ (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"C:\Users\erick\Desktop\Advanced Topics\Week 6\groceries\src\pages\about\about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      About\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n  <!-- Added my name and student ID to this page per the assignment -->\n\n  <p>Matthew Erickson</p>\n  <p>Student ID: 0964509 </p>\n  \n</ion-content>\n'/*ion-inline-end:"C:\Users\erick\Desktop\Advanced Topics\Week 6\groceries\src\pages\about\about.html"*/
        }),
...
var ContactPage = /** @class */ (function () {
    ...
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-contact',template:/*ion-inline-start:"C:\Users\erick\Desktop\Advanced Topics\Week 6\groceries\src\pages\contact\contact.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Contact\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-list-header>Follow us on Twitter</ion-list-header>\n    <ion-item>\n      <ion-icon name="ionic" item-start></ion-icon>\n      @ionicframework\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\erick\Desktop\Advanced Topics\Week 6\groceries\src\pages\contact\contact.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]])
    ], ContactPage);
    return ContactPage;
...
var HomePage = /** @class */ (function () {
    ...
    */
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\erick\Desktop\Advanced Topics\Week 6\groceries\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar class="header">\n    <ion-title>{{title}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n  <h4 padding-top text-center *ngIf = "loadItems().length === 0">\n    You have no items on your list.\n  </h4>\n\n  <ion-list>\n    <ion-item-sliding *ngFor = "let item of loadItems(); let i = index">  \n      <ion-item>\n        <h2>{{item.name}} <span>\n        <ion-list> <!-- Drop down menu to select quantity -->\n          <ion-item>\n            <ion-select [(ngModel)]=item.quantity>\n              <ion-option value="1">1</ion-option>\n              <ion-option value="2">2</ion-option>\n              <ion-option value="3">3</ion-option>\n              <ion-option value="4">4</ion-option>\n              <ion-option value="5">5</ion-option>\n              <ion-option value="6">6</ion-option>\n              <ion-option value="7">7</ion-option>\n              <ion-option value="8">8</ion-option>\n              <ion-option value="9">9</ion-option>\n              <ion-option value="10">10</ion-option>\n            </ion-select>\n          </ion-item>\n        </ion-list>\n      </span></h2>\n      </ion-item>\n\n      <!-- Buttons used with slider to edit, share, or remove an item -->\n\n      <ion-item-options>\n        \n        <!-- Edit item button -->\n        <button (click) ="editItem(item, i)" ion-button color="primary" icon-start>\n          <ion-icon name="ios-create-outline"></ion-icon>\n          Edit\n        </button>\n\n        <!-- Share item button -->\n        <button (click) ="shareItem(item, i)" ion-button color="shareButtom" icon-start>\n          <ion-icon name="md-share"></ion-icon>\n          Share\n        </button>\n\n        <!-- Remove item button -->\n        <button (click) ="removeItem(item, i)" ion-button color="secondary" icon-start>\n          <ion-icon name="ios-trash"></ion-icon>\n          Done\n        </button>\n\n      </ion-item-options>\n    </ion-item-sliding>\n  </ion-list>\n\n  <!-- Displays a FAB button for adding groceries -->\n\n  <ion-fab bottom right padding>\n    <button (click) ="addItem()" ion-fab mini color=\'primary\'><ion-icon name="add"></ion-icon></button>\n  </ion-fab>\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\erick\Desktop\Advanced Topics\Week 6\groceries\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* ToastController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* ToastController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__providers_groceries_groceries__["a" /* GroceriesProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_groceries_groceries__["a" /* GroceriesProvider */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__providers_input_dialog_service_input_dialog_service__["a" /* InputDialogServiceProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_input_dialog_service_input_dialog_service__["a" /* InputDialogServiceProvider */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__["a" /* SocialSharing */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__["a" /* SocialSharing */]) === "function" && _e || Object])
    ], HomePage);
    return HomePage;
    var _a, _b, _c, _d, _e;
}());
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\erick\Desktop\Advanced Topics\Week 6\groceries\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Users\erick\Desktop\Advanced Topics\Week 6\groceries\src\app\app.html"*/
        }),
